...
export function Tooltip() {
    return (
        <div className="p-8 grid aspect-video w-full max-w-md justify-center text-foreground md:grid-cols-2 [&>div]:relative [&>div]:flex [&>div]:h-[237px] [&>div]:w-[24px] [&>div]:items-center [&>div]:justify-center [&>div]:p-4">
            <div>
            ...
            <div className="!hidden md:!flex">
                <TooltipDemo
                    label="Bonus section"
                    payload={[
                        { name: "Navigating Job Offers", value: 1, fill: "hsl(var(--chart-3))" },
                        { name: "Visas", value: 2, fill: "hsl(var(--chart-3))" },
                        { name: "....", value: 3, fill: "hsl(var(--chart-3))" },
                    ]}
                    className="w-[9rem]"
                    indicator="line"
                />
